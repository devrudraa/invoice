...
export const EditInvoiceTemplate: React.FC<Readonly<InvoiceTemplate>> = ({
  invoiceDueDate,
  invoiceNumber,
  name,
  totalAmount,
    ...
    <>
      ...
      >
        <div style={{ padding: "30px 0" }}>
          <h2 style={{ fontSize: "2em" }}>Invoice update for {name}</h2>

          <p>Dear User Whats up {name},</p>

          <p>
            I hope this email finds you well. Please find attached your updated
            invoice attached below
          </p>

          <div>
            <p style={{ fontWeight: "bold" }}>Updated Invoice Details:</p>
